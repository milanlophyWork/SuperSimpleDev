...
/* 
    ...
    console.log(deliveryDate.format('dddd, DD MMM YYYY')) // step 3 : display in easy-to-read format. 
        // 'dddd' display day of the week, 'DD' display date, 'MMM' display month, 'YYYY' display year.
*/
    ...
    function deliveryOptionsHTML(matchingProduct, cartItem){ // step 2 generating the html for deliveryOptions : first loop through delivery options (so import it), then for each option generate some html, and lastly combine the html together
        ...
        deliveryOptions.forEach((deliveryOption)=> {
            ...
            const priceString = deliveryOption.priceCents === 0
                ...
                const isChecked = deliveryOption.id === cartItem.deliveryOptionId // Automating the Checking of option
